...
def run_strategy(
    ...
    #Analyzer methods
    strategy = results[0]
    df = BTAnalyzer.getTradeAnalysisDf(strategy.analyzers.ta.get_analysis())
    df2 = BTAnalyzer.getSQNDf(strategy.analyzers.sqn.get_analysis())
    df3 = BTAnalyzer.getTransactionsDf(strategy.analyzers.transactions.get_analysis())
    df4 = BTAnalyzer.getDrawDownDf(strategy.analyzers.drawdown.get_analysis())
